 ...
 *
 * @str: Indicate string to seperate into words
 * @delims: Indicate delimitors to use to delimit words
 *
 ...
 *
 * @ch: Indicate character in stream
 *
 * @delims: Indicate Pointer to null terminated array of delimitors
 *
 ...
 *
 * @str: Indicate string to get word length from current word
 * @delims: Indicate delimitors to use to delimit words
 *
 ...
 *
 * @str: Indicate string to get word count from
 * @delims: Indicate delimitors to use to delimit words
 *
 ...
 *
 * @str: Indicate string to get next word from
 * @delims: Indicate delimitors to use to delimit words
 *
